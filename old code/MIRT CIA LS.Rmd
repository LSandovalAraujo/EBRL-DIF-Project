...
multimod3 = multipleGroup(CIA[,1:16],
                         ...
                         method = 'QMCEM', 
                         SE = TRUE) #literally just trying it again; items 1, 7, 10, 12, and 16 were identified as anchors based on unidimensional dif using lordif() 
summary(multimod3)
```
...
dif3 <-DIF(multimod3, c('a1', 'a2', 'd1', 'd2', 'd3'),
          ...
          seq_stat= .01,
          method = 'QMCEM') #we're doing it again
dif3
```
